...
Engineers using Code Janitor in a desktop coding-agent workflow. They need
...
Turn a proved Code Janitor Finding into a direct visual investigation
...
- an Archify clone that lacks Code Janitor semantics;
